...
define void @_Z3fooPiS_(i32*, i32*) #3 {
...
define i32 @main() #4 {
  ...
  %3 = getelementptr inbounds [10 x i32], [10 x i32]* %1, i64 0, i64 3
  ...
  %8 = getelementptr inbounds [10 x i32], [10 x i32]* %1, i32 0, i32 0
  %9 = getelementptr inbounds [10 x i32], [10 x i32]* %1, i32 0, i32 0
  call void @_Z3fooPiS_(i32* %8, i32* %9)
