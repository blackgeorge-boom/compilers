...
entry:
  %y = alloca [10 x i32]
  %lvalue_ptr = getelementptr [10 x i32], [10 x i32]* %y, i32 0, i32 1
  store i32 2, i32* %lvalue_ptr
  %lvalue_ptr1 = getelementptr [10 x i32], [10 x i32]* %y, i32 0, i32 1
  %rvalue = load i32, i32* %lvalue_ptr1
  call void @writeInteger(i32 %rvalue)
  call void @hello([10 x i32]* %y)
  %lvalue_ptr2 = getelementptr [10 x i32], [10 x i32]* %y, i32 0, i32 1
...
entry:
  %lvalue_ptr = getelementptr [10 x i32], [10 x i32]* %x, i32 0, i32 1
