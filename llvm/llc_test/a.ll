...
entry:
  ...
  %str_ptr1 = getelementptr [9 x i8], [9 x i8]* @str.5, i32 0, i32 0
...
then:                                             ; preds = %entry
  ...
  %str_ptr3 = getelementptr [2 x i8], [2 x i8]* @str.6, i32 0, i32 0
...
then7:                                            ; preds = %ifcont
  ...
  %str_ptr10 = getelementptr [2 x i8], [2 x i8]* @str.7, i32 0, i32 0
...
elifthen:                                         ; preds = %elif17
  ...
  %str_ptr23 = getelementptr [2 x i8], [2 x i8]* @str.8, i32 0, i32 0
...
elifthen37:                                       ; preds = %elif33
  ...
  %str_ptr41 = getelementptr [2 x i8], [2 x i8]* @str.9, i32 0, i32 0
...
afterloop:                                        ; preds = %then32, %then16
  %str_ptr47 = getelementptr [9 x i8], [9 x i8]* @str.10, i32 0, i32 0
  ...
  %str_ptr49 = getelementptr [2 x i8], [2 x i8]* @str.11, i32 0, i32 0
